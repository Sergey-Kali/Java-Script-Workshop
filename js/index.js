  ...
  function loadUsers(page = 1) {
    fetch(`${API_URL}/users?per_page=${USERS_PER_PAGE}&page=${page}`)
      ...
      .then((data) => {
        ...
        // Get rid of the existing pagination.
        ...
        pagination.innerHTML =
          '<ul class="pagination justify-content-center pagination-lg"></ul>';
        ...
        startPage = Math.max(
          1,
          Math.min(endPage - PAGINATION_PAGES + 1, startPage)
        );

        // Incorporate a button for the initial page.
        pagination
        ...
        // Include a button for the last page.
        pagination
          .querySelector(".pagination")
          .insertAdjacentHTML(
            "beforeend",
      ...
      .catch((error) => {
        ...
        // Eliminate the current pagination.
        const oldPagination = document.getElementById("pagination");
        if (oldPagination) {
          oldPagination.remove();
        }
